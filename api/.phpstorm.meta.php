...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/ibrahim.largo/PhpstormProjects/lunchplanner/api/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/ibrahim.largo/PhpstormProjects/lunchplanner/api/public/storage','logging.default','logging.deprecations.channel',
...
'sanctum.csrf-cookie','caterer.index',
'caterer.show','caterer.store','caterer.update','caterer.destroy','dish.index',
'dish.show','dish.store','dish.update','dish.destroy','feedback.index',
'feedback.show','feedback.store','feedback.update','feedback.destroy','passkey.delete',
'passkey.store','passkeys.authenticate','register',
